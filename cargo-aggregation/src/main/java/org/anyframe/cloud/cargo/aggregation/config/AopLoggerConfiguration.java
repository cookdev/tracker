package org.anyframe.cloud.cargo.aggregation.config;
...
public class AopLoggerConfiguration {
	...
	@AfterReturning("execution(* org.anyframe.cloud.cargo.aggregation.application..*.*(..))")
	...
	@AfterReturning("execution(* org.anyframe.cloud.cargo.aggregation.interfaces..*.*(..))")
	...
	@AfterReturning("execution(* org.anyframe.cloud.cargo.aggregation.infrastructure..*.*(..))")
