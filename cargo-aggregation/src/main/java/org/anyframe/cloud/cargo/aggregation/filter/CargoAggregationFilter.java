package org.anyframe.cloud.cargo.aggregation.filter;
...
public class CargoAggregationFilter implements Filter {

	private static final Logger logger = LoggerFactory
			.getLogger(CargoAggregationFilter.class);
...
//		logger.info("CargoAggregationFilter run txId : "
//				+ txId + " & spanID : " + spanId);
