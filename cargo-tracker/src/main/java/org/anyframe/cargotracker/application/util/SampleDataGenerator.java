package org.anyframe.cargotracker.application.util;

import org.anyframe.cargotracker.domain.model.cargo.*;
import org.anyframe.cargotracker.domain.model.handling.*;
import org.anyframe.cargotracker.domain.model.location.SampleLocations;
import org.anyframe.cargotracker.domain.model.voyage.SampleVoyages;
...
public class SampleDataGenerator {
    ...
    private void unLoadAll() {
        logger.debug("Unloading all existing data.");
    ...
    private void loadSampleLocations() {
        logger.debug("Loading sample locations.");
    ...
    private void loadSampleVoyages() {
        logger.debug("Loading sample voyages.");
    ...
    private void loadSampleCargos() {
        logger.debug("Loading sample cargo data.");
