package org.anyframe.cloud.cargo.tracker.interfaces.booking.web;
...
import org.anyframe.cloud.cargo.tracker.interfaces.booking.facade.dto.Leg;
...
public class CargoBookingController {
	...
	public List<RouteCandidate> getRouteCandidates(@RequestParam String trackingId) {
