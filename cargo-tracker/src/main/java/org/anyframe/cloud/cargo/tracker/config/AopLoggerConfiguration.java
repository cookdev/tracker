...
public class AopLoggerConfiguration {
	...
	@AfterReturning("execution(* org.anyframe.cloud.cargo.tracker.application..*.*(..))")
	...
	@AfterReturning("execution(* org.anyframe.cloud.cargo.tracker.interfaces..*.*(..))")
	...
	@AfterReturning("execution(* org.anyframe.cloud.cargo.tracker.infrastructure..*.*(..))")
