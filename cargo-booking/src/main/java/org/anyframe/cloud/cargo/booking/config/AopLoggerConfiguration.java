package org.anyframe.cloud.cargo.booking.config;
...
public class AopLoggerConfiguration {
	...
	@AfterReturning("execution(* org.anyframe.cloud.cargo.booking.application..*.*(..))")
	...
	@AfterReturning("execution(* org.anyframe.cloud.cargo.booking.interfaces..*.*(..))")
	...
	@AfterReturning("execution(* org.anyframe.cloud.cargo.booking.infrastructure..*.*(..))")
