...
import org.anyframe.cloud.cargo.booking.util.TestUtils;
...
public class CargoBookingIntegrationTests {
	...
	public void setUp() throws Exception{
		...
		ReflectionTestUtils.setField(TestUtils.unwrapProxy(bookingService), "cargoTrackerService", mockCargoTrackerService);
