package org.anyframe.pathfinder.filter;
...
public class CargoTrackerPathfinderFilter implements Filter {

	private static final Logger logger = LoggerFactory
			.getLogger(CargoTrackerPathfinderFilter.class);
...
//		logger.info("CargoTrackerPathfinderFilter run txId : "
//				+ txId + " & spanID : " + spanId);
