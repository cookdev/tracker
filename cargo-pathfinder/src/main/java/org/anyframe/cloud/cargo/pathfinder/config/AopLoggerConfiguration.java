package org.anyframe.cloud.cargo.pathfinder.config;
...
public class AopLoggerConfiguration {
	...
	@AfterReturning("execution(* org.anyframe.cloud.cargo.pathfinder.interfaces..*.*(..))")
	...
	@AfterReturning("execution(* org.anyframe.cloud.cargo.pathfinder.infrastructure..*.*(..))")
