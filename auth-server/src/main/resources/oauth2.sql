...
CREATE TABLE client_grant_default_user_authority
(
  client_id character varying(255) NOT NULL,
  authority_id character varying(50) NOT NULL,
  CONSTRAINT client_grant_default_user_authority_pkey PRIMARY KEY (client_id, authority_id),
...
(
  ...
  CONSTRAINT user_event_history_pkey PRIMARY KEY (id)
)
WITH (
  OIDS=FALSE
);